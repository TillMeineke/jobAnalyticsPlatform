...
class StepStoneScraper(BaseScraper):
    ...
    def __init__(self, max_results: int = 100, days_back: int = 30, headless: bool = True):
            ...
            for job_element in job_elements:
                ...
                try:
                    ...
                    if job_data.get("published_at"):
                        pub_date = datetime.datetime.fromisoformat(job_data["published_at"])
                        if pub_date < cutoff_date:
                            logger.debug(f"Skipping job published before cutoff date: {pub_date}")
                            continue
    ...
    def _extract_job_data(self, job_element) -> Dict:
        ...
        relative_url = url_element["href"] if url_element and "href" in url_element.attrs else ""
        ...
        if date_element and "datetime" in date_element.attrs:
            ...
            if "today" in date_text.lower():
                ...
                published_at = (datetime.datetime.now() - datetime.timedelta(days=1)).isoformat()
    ...
    def get_job_details(self, job_id: str) -> Dict:
        ...
        job_details_items = soup.select("dl.job-listing-details__list dt, dl.job-listing-details__list dd")
